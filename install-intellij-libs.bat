...
:: Usage:
::   install-intellij-libs.bat 13.1.4 "C:\Program Files\JetBrains\IntelliJ IDEA Community Edition 13.1.4" "C:\Program Files (x86)\apache-maven-3.2.5"
...
for %%i in ("%INTELLIJ_HOME%\lib\*.jar") do (
  :: %%~ni - file name (n)
  "%MVN_HOME%\bin\mvn" install:install-file -Dfile="%%i" -DgroupId=com.intellij -DartifactId="%%~ni" -Dversion=%IDEA_VERSION% -Dpackaging=jar
)